...
struct TestCollatz : CppUnit::TestFixture {
    ...
    CPPUNIT_TEST(test_readTwo);
    CPPUNIT_TEST(test_readThree);
    CPPUNIT_TEST(test_readFour);
    CPPUNIT_TEST(test_eval_1);
    CPPUNIT_TEST(test_eval_2);
    CPPUNIT_TEST(test_eval_3);
    CPPUNIT_TEST(test_eval_4);
    CPPUNIT_TEST(test_print);
    CPPUNIT_TEST(test_printTwo);
    CPPUNIT_TEST(test_printThree);
    CPPUNIT_TEST(test_printFour);
    CPPUNIT_TEST(test_solve);
    CPPUNIT_TEST(test_solveTwo);
    CPPUNIT_TEST(test_solveThree);
    CPPUNIT_TEST(test_solveFour);	
